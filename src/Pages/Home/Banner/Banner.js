        ...
        <div className="banner">
            <div className="row container-fluid">
                ...
                <div className="col-md-5 banner-details">
                    ...
                    <br />
                    <button onClick={handleFindBtn} className="btn btn-customize text-white find-btn m-3 px-3 py-2">Find Out More</button>
                    <button onClick={handleAboutBtn} className="btn btn btn-primary about-btn m-3 px-3 py-2">About Us</button>
                </div>
