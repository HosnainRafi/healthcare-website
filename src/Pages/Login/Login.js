...
import img from '../../images/login___4.jpg'
...
const Login = () => {
    ...
    const backgroundStyle = {
        backgroundImage: `linear-gradient(rgba(0.5, 0.5, 0.5, 0.5), rgba(0.9, 0.8, 0.9, 0.9)), URL(${img})`,
    ...
    return (
        <div className="container-fluid text-white shadow-md pt-2 login" style={backgroundStyle}>
            ...
            <div className="d-flex justify-content-center pt-4">
                <form onSubmit={handleEmailForm} className="col-10 col-md-6 px-3 my-2 rounded-3 pb-3">
                    {
                        success &&
