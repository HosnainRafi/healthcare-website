          ...
          <div className="row">
            <div className="col-md-5">
              <div className="left-container text-start">
                ...
                <p className="mt-5">
                  <small>Medi Care © . All rights reserved.</small>
                </p>
              </div>
            </div>
            <div className="col-md-2">
              <div className="footer-menu-container">
                <ul>
                  ...
                  <br />
                  <Link className="footer-menu text-decoration-none text-white pb-4" to="/doctors">Doctors</Link>
                  <br />
            ...
            <div className="col-md-5">
              <div className="right-footer-container">
                <h3>Sign up for <br /> the MediCare</h3>
                <input
